...
Linear regression finds the straight line that best describes how a dependent variable changes as an independent variable changes. Think of it as summarizing a cloud of data points into a single, predictable mathematical rule.
</Callout>
...
Unlike multiple regression, simple linear regression does **not** have a multicollinearity assumption. There's only one predictor, so there's nothing for it to be collinear with!
</Callout>
